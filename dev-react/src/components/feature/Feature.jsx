        ...
        <div className='features-offer'>
            ...
            <div className='features-section1'>
                <div className="offer offer-box1">
                    ...
                    <p>Sharpen your coding skills and reinforce your knowledge through our interactive coding challenges. Designed to simulate real-world scenarios, our challenges offer practical exercises
                        across various programming languages and problem-solving techniques.</p>
                ...
                <div className="offer offer-box3">
                    ...
                    <p>Accelerate your learning journey with our personalized mentorship programs tailored to your individual needs and goals.
                        Our experienced mentors provide one-on-one guidance, constructive feedback, and customized learning plans to help you overcome challenges.</p>
                    <button className="btn">Get Started</button>
                </div>
            </div>
        </div>
