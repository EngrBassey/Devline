...
const course = [
  {
    ...
    img: require("../../assets/cloud-img.jpg"),
    starImg: "",
  },
  {
    name: "JavaScripts for Beginners",
    img: require("../../assets/js-img.png"),
    starImg: "",
  },
  {
    name: "Ethical Hacking",
    img: require("../../assets/hacking-img.jpg"),
    starImg: "",
  },
  {
    name: "Blockchain Development Fundamentals",
    img: require("../../assets/blockchain.jpg"),
    starImg: "",
  },
  {
    name: "Python Crash Course",
    img: require("../../assets/python-icon.jpg"),
    starImg: "",
  },
];
  ...
  return (
    <div className="carousel">
      <div className="carousel-box">
        <h2 id="mentors">Available Courses</h2>
